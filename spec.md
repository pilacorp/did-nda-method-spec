...
## 12\. Test Vectors
  ...
  * **Example 1:** `did:nda:0xdfc8044a202f08b9c8df2e42f746355575816828` → see `examples/nda-doc-1.json` (This implies a valid DID Document file exists at this path in your repository).
